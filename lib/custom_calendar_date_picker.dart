...
class CustomCalendarDatePicker extends StatefulWidget {
  ...
  CustomCalendarDatePicker({
    ...
    this.customCalendarModel = const CustomCalendarModel(),
  ...
  /// The class that convert the data for the [CustomCalendarModel].
  final CustomCalendarModel customCalendarModel;
...
class _CustomCalendarDatePickerState extends State<CustomCalendarDatePicker> {
  ...
  late CustomCalendarModel _customCalendarModel;
    ...
    switch (_mode) {
      case DatePickerMode.day:
        return _MonthPicker(
          ...
          customCalendarModel: _customCalendarModel,
        );
    ...
    return Stack(
      children: <Widget>[
        ...
        _DatePickerModeToggleButton(
          mode: _mode,
          title: _customCalendarModel.getMothName(_currentDisplayedMonthDate,
...
class _MonthPickerState extends State<_MonthPicker> {
  ...
  late final CustomCalendarModel _customCalendarModel;
  ...
  List<Widget> _dayHeaders(
    ...
    for (int i = localizations.firstDayOfWeekIndex; true; i = (i + 1) % 7) {
      final String weekday =
          _customCalendarModel.getWeekDay(i, localizations.narrowWeekdays[i]);
    ...
    Widget yearItem = Center(
      child: Container(
        ...
        child: Center(
          child: Semantics(
            selected: isSelected,
            child: Text(showYear, style: itemStyle),
          ),
        ),
      ),
    );
